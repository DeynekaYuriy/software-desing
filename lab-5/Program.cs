...
var li0 = new LightElementNode("li", NodeType.ElementNode, ClosureType.Even );
var li1 = new LightElementNode("li", NodeType.ElementNode, ClosureType.Even );
var li2 = new LightElementNode("li", NodeType.ElementNode, ClosureType.Even);
li0.AppendChild(new LightTextNode("span", "idk"));
li0.AppendChild(new LightTextNode("span", "idk"));
ul.AppendChild(li1);
ul.AppendChild(li2);
...
ul.Accept(analyzer);
Console.WriteLine("Element nodes: "+analyzer.ElementNodesCount);
Console.WriteLine("Text nodes: " + analyzer.TextNodesCount);
