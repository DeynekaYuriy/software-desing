...
namespace DesignPatterns.Composite
{
    class MarvelHero
    {
        ...
        public string Name { get; private set; }
        public IArtefactLogger logger { get; set; }
        private int _power;

        public MarvelHero(string name, int power, IArtefactLogger logger)
        {
            this.Name = name;
            this._power = power;
            this.logger = logger;
